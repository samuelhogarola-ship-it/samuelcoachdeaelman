...
Zu Hause gibt Sofie ihrer Mutter die Blumen. Die Mutter freut sich sehr. „Die Blumen sind wunderschön!“, sagt sie. Sofie lächelt und umarmt ihre Mutter. Heute ist ein schöner Tag für die Familie.`,
    preguntas: [
      { enunciado: 'Sofie kauft Tulpen für ihre Mutter.', respuesta: true },
      { enunciado: 'Die Tulpen sind blau.', respuesta: false },
      { enunciado: 'Sofie bezahlt fünf Euro.', respuesta: true },
      { enunciado: 'Die Mutter ist traurig über die Blumen.', respuesta: false },
      { enunciado: 'Sofie umarmt ihre Mutter.', respuesta: true },
    ],
  },
  {
...
Um Viertel nach sieben verlasse ich das Haus. Ich fahre mit dem Fahrrad zur Schule. Der Schulweg dauert zehn Minuten. Um halb acht beginnt der Unterricht. Ich bin immer pünktlich in der Schule.`,
    preguntas: [
      { enunciado: 'Der Wecker klingelt um sechs Uhr.', respuesta: true },
      { enunciado: 'Paul isst zum Frühstück ein Ei.', respuesta: false },
      { enunciado: 'Paul fährt mit dem Bus zur Schule.', respuesta: false },
      { enunciado: 'Der Schulweg dauert zehn Minuten.', respuesta: true },
      { enunciado: 'Der Unterricht beginnt um halb acht.', respuesta: true },
    ],
  },
  {
...
Heute gewinnen wir das Spiel drei zu eins. Ich schieße ein Tor. Alle Kinder sind glücklich. Der Trainer sagt: „Das war super!“ Danach feiern wir mit Limonade und Kuchen.`,
    preguntas: [
      { enunciado: 'Tim spielt Fußball als Hobby.', respuesta: true },
      { enunciado: 'Tim spielt jeden Tag im Verein.', respuesta: false },
      { enunciado: 'Tims Mannschaft heißt „Die Adler“.', respuesta: true },
      { enunciado: 'Das Spiel endet unentschieden.', respuesta: false },
      { enunciado: 'Tim schießt ein Tor.', respuesta: true },
    ],
  },
  {
...
Frau Bauer hat sich sehr bei Herrn Weber bedankt, weil er ihr so gut geholfen hat. Sie hat ihm zum Dank einen Kuchen gebacken. Wenn sie das nächste Mal mit Bello spazieren geht, passt sie besser auf. Die ganze Nachbarschaft hat sich über das Happy End gefreut.`,
    preguntas: [
      { enunciado: 'Bello ist aus dem Garten verschwunden.', respuesta: true },
      { enunciado: 'Frau Bauer hat die Polizei angerufen.', respuesta: false },
      { enunciado: 'Ein Junge hat den Hund am Fluss gesehen.', respuesta: true },
      { enunciado: 'Frau Bauer findet Bello nicht.', respuesta: false },
      { enunciado: 'Frau Bauer backt einen Kuchen für Herrn Weber.', respuesta: true },
    ],
  },
  {
...
Am Sonntag sind sie zum Schwimmen an den See gegangen, bevor sie nach Hause gefahren sind. Die Kinder haben gesagt, dass sie im nächsten Sommer wieder zelten möchten. Die Mutter hat gemeint, dass ein Hotel vielleicht bequemer wäre. Trotzdem war es für die ganze Familie ein schönes Abenteuer.`,
    preguntas: [
      { enunciado: 'Familie Krüger ist zum Zelten an einen See gefahren.', respuesta: true },
      { enunciado: 'In der Nacht hat die Sonne geschienen.', respuesta: false },
      { enunciado: 'Das Zelt ist nass geworden.', respuesta: true },
      { enunciado: 'Die Kinder wollen nie wieder zelten.', respuesta: false },
      { enunciado: 'Am Sonntag sind sie schwimmen gegangen.', respuesta: true },
    ],
  },
  {
...
Zwei Wochen später hat Nina geantwortet und geschrieben, dass sie im Sommer nach Deutschland kommen möchte. Julia war so glücklich, dass sie sofort ihre Eltern angerufen hat. Sie hat schon einen Plan gemacht, was sie mit Nina alles unternehmen will. Die beiden Freundinnen freuen sich sehr auf das Wiedersehen.`,
    preguntas: [
      { enunciado: 'Nina lebt jetzt in Kanada.', respuesta: true },
      { enunciado: 'Julia und Nina haben sich letzte Woche getroffen.', respuesta: false },
      { enunciado: 'Nina arbeitet als Lehrerin.', respuesta: true },
      { enunciado: 'Julia hat nicht auf den Brief geantwortet.', respuesta: false },
      { enunciado: 'Nina möchte im Sommer nach Deutschland kommen.', respuesta: true },
    ],
  },
  {
...
Neulich hat Carmen für das Team eine Tapas-Party organisiert, obwohl sie eigentlich viel zu tun hatte. Alle waren begeistert von den kleinen spanischen Gerichten, die sie mitgebracht hatte. Nachdem der Abend so gut angekommen war, planen die Kollegen bereits, daraus eine feste Tradition zu machen. Carmen fühlt sich mittlerweile im Team richtig willkommen und freut sich auf die kommenden gemeinsamen Projekte.`,
    preguntas: [
      { enunciado: 'Carmen kommt aus Spanien und arbeitet im Marketing.', respuesta: true },
      { enunciado: 'Carmen spricht kein Wort Deutsch.', respuesta: false },
      { enunciado: 'In Spanien beginnen Meetings laut Text oft etwas später.', respuesta: true },
      { enunciado: 'Carmen hat keine Party für das Team organisiert.', respuesta: false },
      { enunciado: 'Die Kollegen möchten die Tapas-Party zur Tradition machen.', respuesta: true },
    ],
  },
  {
...
Nachdem das Festival am Sonntagabend zu Ende gegangen war, zeigte sich der Bürgermeister sehr zufrieden mit dem Ergebnis. Er kündigte an, dass das Festival im nächsten Jahr wiederholt werden soll, weil die Resonanz so positiv war. Viele Geschäfte in der Innenstadt berichteten außerdem von deutlich mehr Besuchern als sonst. Die Bewohner, die anfangs skeptisch waren, sind nun die größten Fans des neuen Festivals.`,
    preguntas: [
      { enunciado: 'Das Straßenmusikfestival fand zum ersten Mal statt.', respuesta: true },
      { enunciado: 'Alle Bewohner waren von Anfang an begeistert von der Idee.', respuesta: false },
      { enunciado: 'Eine Gruppe aus Portugal sang Fado-Lieder.', respuesta: true },
      { enunciado: 'Das Festival soll im nächsten Jahr nicht wiederholt werden.', respuesta: false },
      { enunciado: 'Die Geschäfte in der Innenstadt hatten mehr Besucher als sonst.', respuesta: true },
    ],
  },
  {
...
Nach einigen Monaten hat sich Markus an das Tempo und die Anonymität der Großstadt gewöhnt, obwohl er das Dorf immer noch vermisst. Am Wochenende fährt er regelmäßig nach Hause, um seine Familie zu besuchen. Er sagt, dass er jetzt beide Welten zu schätzen weiß: die Ruhe des Dorfes und die Möglichkeiten der Stadt. Trotzdem weiß er noch nicht, wo er in Zukunft wirklich leben möchte.`,
    preguntas: [
      { enunciado: 'Markus ist in einer Großstadt aufgewachsen.', respuesta: false },
      { enunciado: 'Markus ist wegen einer neuen Stelle nach München gezogen.', respuesta: true },
      { enunciado: 'Markus fühlte sich in den ersten Wochen sofort wohl in München.', respuesta: false },
      { enunciado: 'Markus ist einem Sportverein beigetreten.', respuesta: true },
      { enunciado: 'Markus fährt nie mehr in sein Heimatdorf.', respuesta: false },
    ],
  },
  {
...
Am letzten Abend organisierten die Lehrer eine kleine Abschlussfeier mit Musik und heißer Schokolade. Trotzdem waren viele Schüler traurig, dass die Woche schon vorbei war. Auf der Heimfahrt im Bus erzählten alle begeistert von ihren Erlebnissen auf der Piste. Die Klasse ist sich einig, dass diese Skifreizeit eine der schönsten Klassenfahrten überhaupt war.`,
    preguntas: [
      { enunciado: 'Die Skifreizeit findet jedes Jahr im Januar statt.', respuesta: true },
      { enunciado: 'Alle Schüler konnten vorher schon perfekt Ski fahren.', respuesta: false },
      { enunciado: 'Ein Mitschüler hat sich beim Skifahren verletzt.', respuesta: true },
      { enunciado: 'Am letzten Abend gab es keine Feier.', respuesta: false },
      { enunciado: 'Die Klasse fand die Skifreizeit sehr schön.', respuesta: true },
    ],
  },
  {
...
Sollte es gelingen, die Ladeinfrastruktur flächendeckend auszubauen, wäre dies ein entscheidender Schritt für die Verkehrswende. Bis dahin bleibt die Elektromobilität für viele Autofahrer jedoch eher eine Zukunftsvision als eine praktikable Alternative zum Verbrennungsmotor. Es zeigt sich, dass technologische Innovation allein nicht ausreicht, wenn die begleitenden Strukturen nicht mitwachsen.`,
    preguntas: [
      { enunciado: 'Die Bundesregierung möchte, dass bis 2030 viele Elektrofahrzeuge auf den Straßen fahren.', respuesta: true },
      { enunciado: 'In ländlichen Regionen gibt es laut Text ausreichend Ladesäulen.', respuesta: false },
      { enunciado: 'Die „Reichweitenangst“ wird im Text als Hindernis für den Kauf von Elektroautos genannt.', respuesta: true },
      { enunciado: 'Automobilhersteller investieren laut Text unabhängig von der Nachfrage in Ladepunkte.', respuesta: false },
      { enunciado: 'Fachleute fordern staatliche Förderprogramme für den Ausbau der Ladeinfrastruktur.', respuesta: true },
    ],
  },
  {
...
Viele Experten sind sich einig, dass eine Kombination aus klaren gesetzlichen Regelungen, menschlicher Moderation und digitaler Bildung notwendig wäre, um das Problem wirksam anzugehen. Sollten Nutzerinnen und Nutzer schon frühzeitig lernen, verantwortungsvoll mit Sprache im Netz umzugehen, ließe sich ein Teil der Konflikte möglicherweise von vornherein vermeiden. Bis eine solche umfassende Lösung gefunden ist, bleibt die Debatte um Meinungsfreiheit und Hassrede jedoch ein zentrales Streitthema der digitalen Gesellschaft.`,
    preguntas: [
      { enunciado: 'Die Debatte über Meinungsfreiheit und Hassrede wird in sozialen Medien kontrovers diskutiert.', respuesta: true },
      { enunciado: 'In Deutschland gibt es kein Gesetz, das Plattformen zum Löschen strafbarer Inhalte verpflichtet.', respuesta: false },
      { enunciado: 'Algorithmen erkennen laut Text Ironie und Kontext immer zuverlässig.', respuesta: false },
      { enunciado: 'Experten halten eine Kombination aus Gesetzen, Moderation und Bildung für sinnvoll.', respuesta: true },
...
Zu Hause gibt Paul die Milch seiner Mutter. „Danke, Paul", sagt sie und lächelt. Paul isst einen Apfel und ist zufrieden. Später backt seine Mutter einen Kuchen mit der Milch.`,
    preguntas: [
      { enunciado: 'Paul wohnt in Hamburg.', respuesta: true },
      { enunciado: 'Paul kauft Käse für den Kuchen.', respuesta: false },
      { enunciado: 'Die Milch ist im Kühlregal.', respuesta: true },
      { enunciado: 'Paul kauft grüne Äpfel.', respuesta: false },
      { enunciado: 'Pauls Mutter backt einen Kuchen.', respuesta: true },
    ],
  },
  {
...
Am Sonntag isst die Familie zusammen Frühstück. Sie essen Brot, Käse und Oliven. Nach dem Frühstück spielen Ali und Deniz Fußball im Garten. Selin malt ein Bild von der Familie.`,
    preguntas: [
      { enunciado: 'Ali arbeitet als Lehrer.', respuesta: true },
      { enunciado: 'Emine ist Krankenschwester.', respuesta: false },
      { enunciado: 'Deniz ist älter als Selin.', respuesta: false },
      { enunciado: 'Die Familie hat einen Garten.', respuesta: true },
      { enunciado: 'Selin spielt gern Fußball.', respuesta: false },
    ],
  },
  {
...
Um zehn Uhr gehen Tom und Mia nach Hause. Lisa räumt die Küche auf. Sie ist müde, aber der Abend war schön. Sie freut sich schon auf das nächste Treffen mit ihren Freunden.`,
    preguntas: [
      { enunciado: 'Lisa hat am Freitag frei.', respuesta: true },
      { enunciado: 'Tom und Mia kommen am Montag zu Besuch.', respuesta: false },
      { enunciado: 'Lisa macht Popcorn.', respuesta: true },
      { enunciado: 'Mia gewinnt das erste Spiel.', respuesta: false },
      { enunciado: 'Die Freunde gehen um zehn Uhr nach Hause.', respuesta: true },
    ],
  },
  {
...
Seitdem pflückt Herr Bauer keine Äpfel mehr allein. Sein Sohn hilft ihm jetzt jedes Jahr im Garten. „Ich bin froh, dass nichts Schlimmeres passiert ist", hat Herr Bauer zu seiner Frau gesagt.`,
    preguntas: [
      { enunciado: 'Herr Bauer wollte Kirschen pflücken.', respuesta: false },
      { enunciado: 'Die Leiter ist weggerutscht.', respuesta: true },
      { enunciado: 'Der Arm von Herrn Bauer war gebrochen.', respuesta: false },
      { enunciado: 'Herr Bauer musste eine Woche den Arm schonen.', respuesta: true },
      { enunciado: 'Sein Sohn hilft ihm jetzt im Garten.', respuesta: true },
    ],
  },
  {
...
Jana freut sich, dass Sofie eine schöne Reise hat. Sie hat ihr sofort eine Nachricht geschrieben und gefragt, wann sie zurückkommt. Sofie hat geantwortet, dass sie nächste Woche wieder zu Hause ist. Jana möchte dann alle Fotos von der Reise sehen.`,
    preguntas: [
      { enunciado: 'Sofie ist nach Norwegen gefahren.', respuesta: true },
      { enunciado: 'Sofie hat Jana angerufen.', respuesta: false },
      { enunciado: 'In Norwegen war das Wetter kalt und sonnig.', respuesta: true },
      { enunciado: 'Sofie hat keine Tiere gesehen.', respuesta: false },
      { enunciado: 'Sofie kommt nächste Woche zurück.', respuesta: true },
    ],
  },
  {
...
Nach der Arbeit des Gärtners bekommt Herr Wolf wieder mehr Sonne auf seiner Terrasse. Frau Keller ist froh, dass sie eine Lösung gefunden haben, ohne dass der Baum gefällt werden musste. Seitdem trinken die beiden Nachbarn wieder manchmal zusammen Kaffee.`,
    preguntas: [
      { enunciado: 'Frau Keller und Herr Wolf sind neue Nachbarn.', respuesta: false },
      { enunciado: 'Der Baum wirft Schatten auf Herrn Wolfs Terrasse.', respuesta: true },
      { enunciado: 'Frau Keller lässt den Baum sofort fällen.', respuesta: false },
      { enunciado: 'Ein Gärtner kürzt die Äste des Baumes.', respuesta: true },
      { enunciado: 'Die Nachbarn sprechen danach nie wieder miteinander.', respuesta: false },
    ],
  },
  {
...
Am Abend war Nina müde, aber auch stolz auf sich. Trotzdem hatte sie noch viele Fragen an ihre Kollegen, die sie am nächsten Tag stellen wollte. Sie merkte, dass ihr die Arbeit im Café mehr Spaß machte, als sie erwartet hatte, und freute sich schon auf die kommende Woche.`,
    preguntas: [
      { enunciado: 'Nina hat schon vorher in einem Restaurant gearbeitet.', respuesta: true },
      { enunciado: 'Nina kannte die Kaffeemaschine sehr gut.', respuesta: false },
      { enunciado: 'Ein Gast hat sich über Nina beschwert.', respuesta: false },
      { enunciado: 'Nina wurde im Laufe des Tages ruhiger.', respuesta: true },
      { enunciado: 'Am Abend war Nina stolz auf sich.', respuesta: true },
    ],
  },
  {
...
Nach der Vorstellung waren alle erleichtert und glücklich zugleich. Die Theaterlehrerin lobte die ganze Klasse für ihre harte Arbeit und ihren Mut. Trotzdem waren einige Schüler etwas traurig, weil die gemeinsamen Proben nun vorbei waren. Sie beschlossen, im nächsten Jahr wieder ein Stück aufzuführen.`,
    preguntas: [
      { enunciado: 'Die Klasse 9b probt seit einer Woche.', respuesta: false },
      { enunciado: 'Das Theaterstück handelt von einem Umzug in eine neue Stadt.', respuesta: true },
      { enunciado: 'Der Hauptdarsteller vergaß seinen Text und konnte sich nicht erinnern.', respuesta: false },
      { enunciado: 'Das Publikum applaudierte am Ende der Vorstellung.', respuesta: true },
      { enunciado: 'Die Schüler wollen nie wieder ein Theaterstück aufführen.', respuesta: false },
    ],
  },
  {
...
Nach einigen Wochen fühlte sich Julia in Leipzig langsam wohler. Sie lernte durch ihre neue Arbeit interessante Menschen kennen und entdeckte gemeinsam mit Tobias die Stadt. Trotzdem fährt sie noch regelmäßig nach München, um ihre alten Freunde zu besuchen. Für Julia war der Umzug schwierig, aber im Nachhinein die richtige Entscheidung.`,
    preguntas: [
      { enunciado: 'Julia ist von Leipzig nach München gezogen.', respuesta: false },
      { enunciado: 'Julia fand den Abschied von ihren Freunden leicht.', respuesta: false },
      { enunciado: 'Julia hat in Leipzig eine Stelle in einem Verlag bekommen.', respuesta: true },
      { enunciado: 'Tobias hat Julia seinen Freunden vorgestellt.', respuesta: true },
      { enunciado: 'Julia fährt nie wieder nach München.', respuesta: false },
    ],
  },
  {
...
Einige Länder sind bereits einen Schritt weitergegangen: In Großbritannien wurde Werbung für ungesunde Lebensmittel im Fernsehen vor 21 Uhr sowie im Internet weitgehend untersagt. Ob eine solche Regelung tatsächlich zu einer gesünderen Ernährung bei Kindern führt, wird von Wissenschaftlern unterschiedlich bewertet, da Ernährungsgewohnheiten von vielen weiteren Faktoren wie Erziehung und sozialem Umfeld abhängen. Klar ist jedoch, dass das Thema angesichts wachsender Gesundheitskosten weiterhin politisch brisant bleiben dürfte.`,
    preguntas: [
      { enunciado: 'Die Debatte betrifft Werbung für Lebensmittel, die sich an Kinder richtet.', respuesta: true },
      { enunciado: 'Befürworter des Verbots sehen keine Gefahr durch Werbung für Kinder.', respuesta: false },
      { enunciado: 'Kritiker meinen, die Verantwortung liege vor allem bei den Eltern.', respuesta: true },
      { enunciado: 'Die Lebensmittelindustrie befürchtet wirtschaftliche Nachteile durch ein Werbeverbot.', respuesta: true },
      { enunciado: 'In Großbritannien gibt es bisher keine Einschränkungen für solche Werbung.', respuesta: false },
    ],
  },
  {
...
Manche Plattformbetreiber haben bereits reagiert und Funktionen eingeführt, mit denen Nutzer den Algorithmus stärker selbst steuern oder deaktivieren können. Ob solche Maßnahmen ausreichen, um die beschriebenen Effekte einzudämmen, wird von Experten unterschiedlich beurteilt. Würde man Algorithmen konsequent transparenter gestalten, so argumentieren manche Forscher, könnten Nutzer bewusster mit den ihnen präsentierten Inhalten umgehen und die eigene Informationsvielfalt aktiver mitbestimmen.`,
    preguntas: [
      { enunciado: 'Algorithmen zeigen Nutzern zufällig ausgewählte, unpersonalisierte Inhalte an.', respuesta: false },
      { enunciado: 'Filterblasen können dazu führen, dass Nutzer vor allem ihre eigene Meinung bestätigt sehen.', respuesta: true },
      { enunciado: 'Wissenschaftler sehen in Filterblasen eine mögliche Gefahr für den gesellschaftlichen Zusammenhalt.', respuesta: true },
      { enunciado: 'Alle Plattformbetreiber haben bisher jede Reaktion auf das Problem abgelehnt.', respuesta: false },
      { enunciado: 'Mehr Transparenz bei Algorithmen könnte laut manchen Forschern helfen.', respuesta: true },
    ],
  },
  {
...
Befürworter entgegnen, dass Achtsamkeit nicht als Ersatz für notwendige strukturelle Veränderungen gedacht sei, sondern als sinnvolle Ergänzung dazu dienen könne. Entscheidend sei, wie Achtsamkeit eingesetzt werde: als ehrliches Angebot zur persönlichen Entlastung oder lediglich als kostengünstige Maßnahme, um tiefere organisatorische Probleme zu übertünchen. Diese Debatte zeigt exemplarisch, wie ein ursprünglich individuelles Konzept gesellschaftlich unterschiedlich interpretiert und genutzt werden kann.`,
    preguntas: [
      { enunciado: 'Achtsamkeit stammt ursprünglich aus einer buddhistischen Praxis.', respuesta: true },
      { enunciado: 'Nur Privatpersonen bieten inzwischen Achtsamkeitsübungen an, keine Unternehmen.', respuesta: false },
      { enunciado: 'Manche Soziologen kritisieren den Trend als neue Form der Selbstoptimierung.', respuesta: true },
      { enunciado: 'Laut der Kritik werden durch Achtsamkeit stets auch die strukturellen Ursachen von Stress gelöst.', respuesta: false },
...
Der Kuchen kommt in den Ofen. Nach einer Stunde ist er fertig. Lena und ihre Mutter schreiben „Alles Gute" mit Zuckerguss auf den Kuchen. Am Abend bringen sie den Kuchen zu Oma. Oma freut sich sehr.`,
    preguntas: [
      { enunciado: 'Lena backt einen Kuchen für ihre Mutter.', respuesta: false },
      { enunciado: 'Der Kuchen ist ein Schokoladenkuchen.', respuesta: true },
      { enunciado: 'Lena kostet den Teig.', respuesta: true },
      { enunciado: 'Der Kuchen bleibt drei Stunden im Ofen.', respuesta: false },
      { enunciado: 'Oma freut sich über den Kuchen.', respuesta: true },
    ],
  },
  {
...
Die Mutter ruft: „Kommt zum Essen!" Tim und Ben gehen ins Haus. Sie sind müde, aber glücklich. Morgen spielen sie wieder Fußball.`,
    preguntas: [
      { enunciado: 'Tim macht jeden Morgen Sport.', respuesta: false },
      { enunciado: 'Ben ist der Bruder von Tim.', respuesta: true },
      { enunciado: 'Sie spielen im Garten Fußball.', respuesta: true },
      { enunciado: 'Tim schießt kein Tor.', respuesta: false },
      { enunciado: 'Nach dem Spiel sind Tim und Ben müde.', respuesta: true },
    ],
  },
  {
...
Am Sonntag backt Frau Klein oft Kekse. Sie gibt mir immer ein paar Kekse. Die Kekse schmecken sehr lecker. Ich mag meine Nachbarin sehr.`,
    preguntas: [
      { enunciado: 'Frau Klein wohnt weit weg.', respuesta: false },
      { enunciado: 'Frau Klein hat einen Garten mit Blumen.', respuesta: true },
      { enunciado: 'Die Katze von Frau Klein heißt Mimi.', respuesta: true },
      { enunciado: 'Mimi ist eine weiße Katze.', respuesta: false },
      { enunciado: 'Frau Klein backt am Sonntag Kekse.', respuesta: true },
    ],
  },
  {
...
Am Abend sind Herr Berger und seine Tochter zum Park gegangen. Dort haben sie Minka endlich gefunden. Die Katze hatte Hunger, aber sonst ging es ihr gut. Die ganze Familie war sehr froh, dass Minka wieder zu Hause war.`,
    preguntas: [
      { enunciado: 'Minka ist die Katze von Familie Berger.', respuesta: true },
      { enunciado: 'Die Familie hat Minka sofort am Montagabend gefunden.', respuesta: false },
      { enunciado: 'Frau Berger hat Zettel im Viertel aufgehängt.', respuesta: true },
      { enunciado: 'Ein Nachbar hat die Katze im Supermarkt gesehen.', respuesta: false },
      { enunciado: 'Die Familie hat Minka schließlich im Park gefunden.', respuesta: true },
    ],
  },
  {
...
Am schwierigsten war die letzte Strecke, weil man dort über eine wackelige Brücke gehen musste. Alle vier haben es trotzdem geschafft. Zum Schluss sind sie mit einer langen Seilrutsche zurück zum Boden gefahren. Müde, aber zufrieden, sind sie am Abend nach Hause gefahren.`,
    preguntas: [
      { enunciado: 'Jonas ist allein zum Kletterpark gefahren.', respuesta: false },
      { enunciado: 'Der Kletterpark liegt mitten in der Stadt.', respuesta: false },
      { enunciado: 'Alle bekommen einen Helm und einen Gurt.', respuesta: true },
      { enunciado: 'Die letzte Strecke war besonders leicht.', respuesta: false },
      { enunciado: 'Am Ende fahren sie mit einer Seilrutsche nach unten.', respuesta: true },
    ],
  },
  {
...
Herr Wagner musste fast zwanzig Minuten warten, bis der Techniker gekommen ist und die Tür geöffnet hat. Er war froh, dass alles gut ausgegangen ist, obwohl er dadurch zu spät zur Arbeit gekommen ist. Sein Chef hat zum Glück Verständnis gezeigt.`,
    preguntas: [
      { enunciado: 'Herr Wagner wohnt im zweiten Stock.', respuesta: false },
      { enunciado: 'Der Fahrstuhl hat sich am Dienstag nicht bewegt.', respuesta: true },
      { enunciado: 'Herr Wagner hat sofort die Tür selbst geöffnet.', respuesta: false },
      { enunciado: 'Ein Techniker hat die Tür geöffnet.', respuesta: true },
      { enunciado: 'Herr Wagner ist pünktlich zur Arbeit gekommen.', respuesta: false },
    ],
  },
  {
...
Nachdem beide Nachbarn eine Nacht darüber geschlafen hatten, trafen sie sich am nächsten Morgen erneut. Diesmal sprachen sie ruhiger miteinander und einigten sich schließlich darauf, die Parkplätze abwechselnd zu nutzen. Seitdem gibt es keinen Streit mehr, und die beiden grüßen sich sogar freundlich, wenn sie sich im Treppenhaus begegnen.`,
    preguntas: [
      { enunciado: 'In der Wohnanlage gibt es genug Parkplätze für alle.', respuesta: false },
      { enunciado: 'Herr Petrov hatte offiziell einen festen Parkplatz reserviert.', respuesta: false },
      { enunciado: 'Herr Fischer war sofort einverstanden, den Platz zu teilen.', respuesta: false },
      { enunciado: 'Die beiden Nachbarn trafen sich am nächsten Tag erneut.', respuesta: true },
      { enunciado: 'Am Ende einigten sich die Nachbarn friedlich.', respuesta: true },
    ],
  },
  {
...
Die ersten Monate waren anstrengend, weil sie sowohl theoretisches Wissen lernen als auch praktische Erfahrungen im Krankenhaus sammeln musste. Nachdem sie die Prüfung bestanden hatte, bekam Sabine eine feste Stelle in einer Klinik. Heute ist sie überzeugt, dass die Umschulung die richtige Entscheidung war, obwohl der Weg dorthin nicht leicht war.`,
    preguntas: [
      { enunciado: 'Sabine hat vorher als Krankenpflegerin gearbeitet.', respuesta: false },
      { enunciado: 'Das Modegeschäft, in dem Sabine arbeitete, wurde geschlossen.', respuesta: true },
      { enunciado: 'Sabine hat sich ohne Beratung sofort umschulen lassen.', respuesta: false },
      { enunciado: 'Die Ausbildung war für Sabine völlig problemlos.', respuesta: false },
      { enunciado: 'Am Ende bekommt Sabine eine feste Stelle in einer Klinik.', respuesta: true },
    ],
  },
  {
...
Am zweiten Tag machte die Gruppe eine Fahrradtour entlang der Küste. Katrin war besonders begeistert von den Steilküsten, die sie noch nie zuvor gesehen hatte. Nachdem sie am Nachmittag zurückgefahren waren, waren sich alle einig, dass dieser Ausflug einer der schönsten seit Langem gewesen war.`,
    preguntas: [
      { enunciado: 'Der Ausflug fand an einem See in den Bergen statt.', respuesta: false },
      { enunciado: 'Die Gruppe ist mit dem Bus gefahren.', respuesta: true },
      { enunciado: 'Wegen des Windes ist niemand baden gegangen.', respuesta: false },
      { enunciado: 'Am zweiten Tag machte die Gruppe eine Fahrradtour.', respuesta: true },
      { enunciado: 'Am Ende fanden alle den Ausflug enttäuschend.', respuesta: false },
    ],
  },
  {
...
Experten fordern daher, dass Schulen verpflichtende Aufklärungsprogramme zum verantwortungsvollen Umgang mit digitalen Medien einführen sollten, bevor es überhaupt zu Vorfällen kommt. Auch die Betreiber sozialer Netzwerke stehen zunehmend in der Verantwortung, Meldemechanismen zu verbessern, damit betroffene Jugendliche schneller Hilfe erhalten. Ohne ein Zusammenspiel von Prävention, elterlicher Aufmerksamkeit und technischen Schutzmaßnahmen dürfte sich das Problem jedoch kaum nachhaltig lösen lassen.`,
    preguntas: [
      { enunciado: 'Cybermobbing endet laut Text automatisch, sobald die Schule vorbei ist.', respuesta: false },
      { enunciado: 'Die scheinbare Anonymität im Internet senkt laut Text die Hemmschwelle der Täter.', respuesta: true },
      { enunciado: 'Beleidigende Inhalte verschwinden dem Text zufolge sofort, wenn sie gelöscht werden.', respuesta: false },
      { enunciado: 'Experten fordern Aufklärungsprogramme an Schulen.', respuesta: true },
      { enunciado: 'Laut Text tragen die Betreiber sozialer Netzwerke keinerlei Verantwortung.', respuesta: false },
    ],
  },
  {
...
Als Alternative wird zunehmend der Begriff der Slow Fashion diskutiert, bei der Kleidung bewusster gekauft und länger getragen werden soll. Auch Second-Hand-Plattformen und Kleidertauschbörsen gewinnen an Beliebtheit, weil sie es ermöglichen, bereits produzierte Kleidung weiterzuverwenden, anstatt ständig neue Ware zu kaufen. Ob sich dieser Trend jedoch gegen die niedrigen Preise der großen Modeketten durchsetzen kann, bleibt abzuwarten.`,
    preguntas: [
      { enunciado: 'Fast Fashion bezeichnet besonders langlebige und teure Kleidung.', respuesta: false },
      { enunciado: 'Die Produktion von Fast Fashion verbraucht laut Text viel Wasser und Energie.', respuesta: true },
      { enunciado: 'Synthetische Fasern können beim Waschen Mikroplastik freisetzen.', respuesta: true },
      { enunciado: 'Slow Fashion bedeutet, möglichst oft neue Kleidung zu kaufen.', respuesta: false },
      { enunciado: 'Laut Text ist bereits sicher, dass Slow Fashion sich durchsetzen wird.', respuesta: false },
    ],
  },
  {
...
Dennoch zeigen aktuelle Entwicklungen, dass Gewerkschaften durchaus in der Lage sind, sich anzupassen. So haben einige Organisationen begonnen, gezielt Beschäftigte in der Logistikbranche oder im Dienstleistungssektor anzusprechen, in denen die Arbeitsbedingungen oft besonders schwierig sind. Ob es den Gewerkschaften gelingt, dadurch langfristig wieder mehr Mitglieder zu gewinnen, wird maßgeblich davon abhängen, wie überzeugend sie ihre Relevanz für eine zunehmend flexible Arbeitswelt vermitteln können.`,
    preguntas: [
      { enunciado: 'Gewerkschaften spielten laut Text historisch keine Rolle bei Arbeitnehmerrechten.', respuesta: false },
      { enunciado: 'Die Zahl der Gewerkschaftsmitglieder ist in vielen Branchen zurückgegangen.', respuesta: true },
      { enunciado: 'In der Plattformökonomie greifen klassische gewerkschaftliche Strukturen laut Text besonders gut.', respuesta: false },
      { enunciado: 'Einige Gewerkschaften sprechen gezielt Beschäftigte in der Logistikbranche an.', respuesta: true },
