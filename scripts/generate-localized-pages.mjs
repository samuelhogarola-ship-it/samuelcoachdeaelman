...
const copy = {
  de: {
    ...
    resources: {
      ...
      cards: [
        ["1", "Leseverstehen", "Texte auf Deutsch mit interaktiven Aufgaben, damit du Lesekompetenz nach Niveau trainieren kannst.", ["A1, B1 und B2", "prüfungsnahe Leseübungen", "geeignet für TELC und Goethe"], "/leseverstehen/", "Kostenlos", "Verfügbar"],
  ...
  en: {
    ...
    resources: {
      ...
      cards: [
        ["1", "Leseverstehen", "German texts with interactive tasks to train reading comprehension by level.", ["A1, B1 and B2", "exam-style reading practice", "suited to TELC and Goethe"], "/leseverstehen/", "Free", "Available"],
